        ...
        <div className='flex min-h-screen w-full'>
            ...
            <div className='flex justify-center mt-6'>
                <p className='text-sm text-[#ababab]'>
                    {isRegister ? "Already have an account ?" : "Don't have an account ?"}<a onClick={() => setIsRegister(!isRegister)} className='text-yellow-400 font-semibold hover:underline' href="#"> {isRegister ? "Sign in" : "Register"}</a>
                </p>
            </div>
            </div>
        </div>
